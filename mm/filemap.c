 ...
 */
int __attribute__((optimize("O0"))) __filemap_fdatawrite_range(struct address_space *mapping, loff_t start,
 ...
 */
int __attribute__((optimize("O0"))) filemap_write_and_wait_range(struct address_space *mapping,
...
int __attribute__((optimize("O0"))) add_to_page_cache_lru(struct page *page, struct address_space *mapping,
				pgoff_t offset, gfp_t gfp_mask)
{
	void *shadow = NULL;
	int ret;
 ...
 */
ssize_t __attribute__((optimize("00"))) do_generic_file_read(struct file *filp, loff_t *ppos,
 ...
 */
int __attribute__((optimize("O0"))) filemap_fault(struct vm_area_struct *vma, struct vm_fault *vmf)
{
	int error;
...
void __attribute__((optimize("O0"))) filemap_map_pages(struct fault_env *fe,
